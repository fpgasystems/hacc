...
#define directories
DIR="/home/$username/my_projects/mpi/$project_name"
#SHELL_BUILD_DIR="/home/$username/my_projects/mpi/$project_name/hw/build"
#DRIVER_DIR="/home/$username/my_projects/mpi/$project_name/driver"
...
if ! [ -d "$DIR" ]; then
    ...
    echo ""
    sleep 1
    echo "mpicc $DIR/src/mpi_hello.c -I $MPICH_WORKDIR/include -L $MPICH_WORKDIR/lib -o $APP_BUILD_DIR/main"
    echo ""
