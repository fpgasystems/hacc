...
#get parameters
upstream_port=$1 #$(/opt/cli/get/get_device_param $device_index upstream_port)
root_port=$2 #$(/opt/cli/get/get_device_param $device_index root_port)
LinkCtl=$3 #$(/opt/cli/get/get_device_param $device_index LinkCtl)
