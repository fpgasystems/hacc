...
enable_vitis_help() {
    ...
    echo ""
    echo "Enables Vitis SDK (Software Development Kit) and Vitis_HLS (High-Level Synthesis) on your server."
    echo ""
    echo "FLAGS:"
...
enable_vivado_help() {
    ...
    echo ""
    echo "Enables Vivado HDI (Hardware Design and Implementation) on your server."
    echo ""
    echo "FLAGS:"
