...
* Deploy, build and design using any of our shipped [Applications](./applications.md)—including, for example, [EasyNet](./applications.md#easynet-100-gbe-network-for-hls) or [Coyote](./applications.md#coyote).
